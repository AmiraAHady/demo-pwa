...
const app = (() => {
  ...
  Notification.requestPermission((status) => {
    console.log("Notification Permission stataus is", status);
  });
      ...
      navigator.serviceWorker
        ...
        .then((regObj) => {
          const myNotification = {
            ...
            action:[
              {action:'explore',title:'show Page',icon:'../images/checkmark.png'},
              {action:'close',title:'Close',icon:'../images/xmark.png'},
            ]
          };
          regObj.showNotification('WArning!',myNotification);
        })
        .catch((err) => {
